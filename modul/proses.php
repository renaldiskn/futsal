<style>
    ...
    .bg-img{
    background-image: url(Gambar/puncak3.jpeg);
    height: 100%; 
...
<head>
  <style>
    /* Mengubah warna teks pada elemen <legend> */
    legend {
      color: white; /* Ganti "green" dengan warna yang Anda inginkan */
    }
  </style>
</head>
<body>
  <fieldset>
    ...
    <!-- Tempatkan formulir atau konten lainnya di sini -->
  </fieldset>
</body>
</html>
 ...
 <style>
  /* Mengubah warna teks pada elemen <label> dengan class "control-label" */
  label.control-label {
    color: white; /* Ganti "red" dengan warna yang Anda inginkan */
  }
</style>
                      ...
                      <label class="control-label" ><b>Nomor Telpon</b></label>
