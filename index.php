 <style>
  .bg-img{
    background-image: url(Gambar/puncak.JPG);
...
<body>
  ...
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.php">
        ...
        <div class="nav-collapse">
          <?php if (empty($_SESSION['namapengunjung'])) {
            ...
            <ul class="nav pull-right">
              <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i> <?php echo $_SESSION['namapengunjung']; ?> <b class="caret"></b></a>
...
<!-- 
  ...
  <footer class="application-footer">
    <div class="container">
      <p><b>Aplikasi Booking Lapangan Puncak Futsal</b></p>
